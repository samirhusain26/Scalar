/** ISO 3166-1 alpha-3 → alpha-2 mapping for all countries in the game. */
...
/** Returns the flag emoji for a given ISO 3166-1 alpha-3 code, or '' if unknown. */
export function getCountryFlag(alpha3: string): string {
